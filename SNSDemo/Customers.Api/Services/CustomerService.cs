...
public class CustomerService : ICustomerService
{
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _snsMessenger.PublishedMessageAsync(customer.ToCustomerCreatedMessage());
        }
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _snsMessenger.PublishedMessageAsync(customer.ToCustomerUpdatedMessage());
        }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        if (response)
        {
            await _snsMessenger.PublishedMessageAsync(new CustomerDeletedMessage(id));
        }
